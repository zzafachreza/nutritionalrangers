    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <MyCalendar label="Tanggal Lahir" iconname="calendar" value={kirim.tanggal_lahir} onDateChange={x => setKirim({
                    ...kirim,
                    tanggal_lahir: x
                })} />
                <MyGap jarak={10} />
                ...
                <MyPicker iconname="options" label="Role" value={kirim.level} onValueChange={x => {
                    setKirim({
                        ...kirim,
                        level: x
                    })
