    ...
    return (
        <ImageBackground
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.page}>
                ...
                <MyCalendar label="Tanggal Lahir" iconname="calendar" value={data.tanggal_lahir} onDateChange={x => setData({
                    ...data,
                    tanggal_lahir: x
                })} />
                ...
                ]} iconname="male-female" label="Jenis Kelamin" value={data.jenis_kelamin} onValueChange={x => setData({
                    ...data,
                    jenis_kelamin: x
                })} />
                <MyGap jarak={10} />
                ...
                ]} iconname="options" label="Role / Level" value={data.level} onValueChange={x => setData({
                    ...data,
                    level: x
                })} />
